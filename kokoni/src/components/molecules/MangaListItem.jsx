...
const MangaListItem = ({ title, author, cover, isAdded, onClick, onAddClick, genres = [] }) => {
  ...
  return (
    <article 
      ...
      onClick={onClick}
    >
      <figure className="relative w-[60px] h-[85px] shrink-0 .eaf-shape overflow-hidden shadow-[0_0_15px_rgba(0,0,0,0.5)]">
        <img 
          src={cover} 
          alt={title} 
      ...
      <section className="flex-1 flex flex-col justify-center overflow-hidden">
